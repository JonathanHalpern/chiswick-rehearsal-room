...
const base64 = __webpack_require__(87);
const qp = __webpack_require__(88);
const mimeTypes = __webpack_require__(83);
...
const net = __webpack_require__(62);
const tls = __webpack_require__(89);
const os = __webpack_require__(21);
...
const os = __webpack_require__(21);
const fs = __webpack_require__(61);
const punycode = __webpack_require__(86);
const PassThrough = __webpack_require__(3).PassThrough;
...
function handler(event, context, callback) {
  ...
  if (!(name && email && bookingDate && startTime && endTime)) {
    ...
    instance.post('/hey', bookingObject).then(response => {
      ...
      mailTransport.sendMail(mailOptions).then(() => console.log(`messaged ${bookingObject.email}`)).catch(error => console.error('There was an error while sending the email:', error));
      callback(null, {
        statusCode: 200,
...
const Mailer = __webpack_require__(97);
const shared = __webpack_require__(5);
...
const StreamTransport = __webpack_require__(116);
const JSONTransport = __webpack_require__(117);
const SESTransport = __webpack_require__(118);
const fetch = __webpack_require__(32);
const packageData = __webpack_require__(8);
...
const MimeNode = __webpack_require__(85);
const mimeFuncs = __webpack_require__(33);
...
const SMTPConnection = __webpack_require__(63);
const wellKnown = __webpack_require__(91);
const shared = __webpack_require__(5);
const packageData = __webpack_require__(8);
...
const XOAuth2 = __webpack_require__(90);
const EventEmitter = __webpack_require__(13);
...
const spawn = __webpack_require__(115).spawn;
const packageData = __webpack_require__(8);
const LeWindows = __webpack_require__(64);
const LeUnix = __webpack_require__(92);
const shared = __webpack_require__(5);
